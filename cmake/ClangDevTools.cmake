...
if(CLANG_FORMAT_FOUND)
	if(PROJECT_CHECK_FORMAT)
		file(GLOB_RECURSE ALL_FILES ${HPP_FILES} ${TEST_HPP_FILES} ${SRC_FILES} ${MAIN_FILE} ${TEST_SRC_FILES})
	else()
...
if(CLANG_TIDY_FOUND)
	if(PROJECT_CHECK_TIDY)
		file(GLOB_RECURSE ALL_SOURCE_FILES ${SRC_FILES} ${MAIN_FILE} ${TEST_SRC_FILES})
	else()
		file(GLOB_RECURSE ALL_SOURCE_FILES ${ENGINE_SRC_FILES} ${MAIN_FILE} ${ENGINE_TEST_SRC_FILES})
	endif()
