...
#ifndef CAMERATREELOD_H
#define CAMERATREELOD_H
...
class CameraTreeLOD : public BasicCamera
{
	Q_OBJECT
  public:
	CameraTreeLOD(VRHandler const* vrHandler);
  ...
  private:
	...
	// VR Controls related attributes
